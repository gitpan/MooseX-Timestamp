# This Makefile is for the MooseX::Timestamp extension to perl.
#
...
#     ABSTRACT => q[Timestamp subtypes for Moose classes]
#     AUTHOR => q[Sam Vilain <samv.org>]
#     DIR => []
#     DISTNAME => q[MooseX-Timestamp]
#     NAME => q[MooseX::Timestamp]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Sub::Exporter=>q[0], Moose=>q[0.32] }
#     VERSION => q[0.01]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/MooseX/Timestamp.pm \
	lib/MooseX/TimestampTZ.pm
...
TO_INST_PM = lib/MooseX/Timestamp.pm \
	lib/MooseX/TimestampTZ.pm

PM_TO_BLIB = lib/MooseX/TimestampTZ.pm \
	blib/lib/MooseX/TimestampTZ.pm \
	lib/MooseX/Timestamp.pm \
...
DISTNAME = MooseX-Timestamp
DISTVNAME = MooseX-Timestamp-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/MooseX/TimestampTZ.pm $(INST_MAN3DIR)/MooseX::TimestampTZ.$(MAN3EXT) \
	  lib/MooseX/Timestamp.pm $(INST_MAN3DIR)/MooseX::Timestamp.$(MAN3EXT) 
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Timestamp subtypes for Moose classes</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Sam Vilain &lt;samv.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Moose" VERSION="0,32,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/MooseX/TimestampTZ.pm blib/lib/MooseX/TimestampTZ.pm \
	  lib/MooseX/Timestamp.pm blib/lib/MooseX/Timestamp.pm 
